                ...
                <div class="col text-end icons">
                    <form action="search">
                        <div class="input-group" id="search">
                            <input type="text" class="form-control" placeholder="<?php l('tpl_search') ?>" name="s">
                    ...
                    <div class="dropdown d-inline-block">
                        ...
                        <ul class="dropdown-menu">
                            <?php if (empty($_SESSION['user'])): ?>
                                <li><a class="dropdown-item" href="user/login"><?php l('tpl_login'); ?></a></li>
                                <li><a class="dropdown-item" href="user/signup"><?php l('tpl_signup'); ?></a></li>
                            <?php else: ?>
                                <li><a class="dropdown-item" href="user/cabinet"><?php l('tpl_cabinet'); ?></a></li>
                                <li><a class="dropdown-item" href="user/logout"><?php l('tpl_logout'); ?></a></li>
                            <?php endif; ?>
                        </ul>
                    </div>
